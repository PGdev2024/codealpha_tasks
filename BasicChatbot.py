...
def repeat(): #Repeat function defined to include repeated chatting with ChatPy by the user 
  while True: #While loop to implement repeated chatting functionality without using recursion to avoid stack overflow for longer chats
    ...
    else: #Handling invalid response from the user side 
      print("⚠️ Invalid response! Please enter 'Y' or 'N'.")
repeat()#Calling repeat function for like once or the first time to intialise the continued chat cycle or the continuation